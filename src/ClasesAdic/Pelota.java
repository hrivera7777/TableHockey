...
public class Pelota {
    ...
    private double dx = 1, dy = 1; // estos son los valores que van sumando a posX y PosY que representan la posicion de la pelota
    ...
    public static int min = 3, seg = 0;// tiempo de juego máximo con minutos y segundos
