...
public class Ventana extends JFrame {
    ...
    private Tablero tablero; // declaracion del objeto tablero (para mostrar el tablero de juego)  
    private Hilo hilo; // declaracion del obejeto tipo Hilo para que el programa se guie de un una unica secuencia
    ...
    public Ventana() {
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // termina la ejecucion del juego cuando se cierra la ventana // método heredados de JFrame 
